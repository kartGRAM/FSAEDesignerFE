...
>(
  (
    ...
    }, [onChange, onStart, onEnd, controls, invalidate, regress, performance]);
    ...
    const fitToScreen = React.useCallback(
      (quaternion: THREE.Quaternion) => {
        ...
        if (isPerspectiveCamera(camera)) {
          ...
          controls.target = cameraCenterVec
            .multiplyScalar(s)
            .add(moveTo.current);
    ...
    }, [camera, fitToScreen, viewDirectionTo]);
